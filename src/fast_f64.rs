...
pub struct FastF64(pub f64);

impl Zero for FastF64 {
    fn zero() -> Self {
        Self(f64::zero())
    }
...
impl One for FastF64 {
    fn one() -> Self {
        Self(f64::one())
    }
}

impl Num for FastF64 {
...
impl FromPrimitive for FastF64 {
...
impl NumCast for FastF64 {
    fn from<T: ToPrimitive>(n: T) -> Option<Self> {
        <f64 as NumCast>::from(n).map(Self)
    }
}

impl Float for FastF64 {
    fn nan() -> Self {
        Self(f64::nan())
    }
...
impl std::fmt::Display for FastF64 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.0.fmt(f)
    }
}

impl Neg for FastF64 {
    type Output = Self;
